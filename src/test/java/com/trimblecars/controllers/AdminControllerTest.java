...
class AdminControllerTest {
    ...
    void testLeaseCar_Success() {
        ...
        assertEquals(leasedCar.getCar().getRegistrationNo(), "MH12AB1234");
    ...
    void testEnrollCar_Success() {
        ...
        assertEquals(enrolledCar.getRegistrationNo(), "MH12AB1234");
    ...
    void testEndLease_Success() {
        ...
        assertEquals(endedLease.getReturnDate(), LocalDate.now());
        verify(leaseRepository, times(1)).save(any(Lease.class));
    }
}
